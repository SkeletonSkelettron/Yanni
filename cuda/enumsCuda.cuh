...
enum class GradientType { Static, Momentum };

enum class NetworkType { Normal, AutoEncoder };
...
enum class Metrics { None, TestSet, Full };

enum class LossCalculation { None, Full };
...
enum class LogLoss { None, Sparce, Full };
} // namespace NeuNetCuda
